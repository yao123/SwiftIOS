...
class YSettingCell: UITableViewCell {

    /// 标题
    var productTitle:UILabel?
    var productImage:UIImageView?
    
    var dataModel:YSettingModel?{
        didSet {
         
            productTitle?.text = dataModel?.name
    ...
    private func setUpUI() {
        ...
        arrowImage.image = UIImage.init(named: "Settin_RightArrow_icon")
